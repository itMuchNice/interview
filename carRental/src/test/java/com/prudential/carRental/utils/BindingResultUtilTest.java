...
public class BindingResultUtilTest {

    @Test
    public void processBindingResultWithNull(){
        String result = BindingResultUtil.processBindingResult(null);
        Assert.assertEquals("", result);
    }

    @Test
    public void processBindingResultWithNoErrors(){
        ...
        String result = BindingResultUtil.processBindingResult(bindingResult);
        Assert.assertEquals("", result);
    }
    ...
    public void processBindingResult(){
        BindingResult bindingResult = new BindingResult() {
            ...
            @Override
            public List<FieldError> getFieldErrors() {
                FieldError fieldError = new FieldError("obj", "test", "only test");
        ...
        String result = BindingResultUtil.processBindingResult(bindingResult);
        Assert.assertEquals("only test;", result);
    }
